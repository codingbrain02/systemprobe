    ...
    <div className="min-h-screen bg-gray-900">
      ...
      <nav className="border-b border-gray-800 bg-gray-900/80 backdrop-blur-sm sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          <img
            src="/SYSTEMPROBE_LOGO_LANDSCAPE.png"
            alt="SystemProbe Security"
            className="h-8"
          />
          <div className="flex items-center gap-8">
            ...
            <a href="#support" className="text-gray-300 hover:text-cyan-400">
              Support
            </a>
            <a href="#business" className="text-gray-300 hover:text-cyan-400">
              For Business
            </a>
          </div>
        </div>
      ...
      <main className="max-w-5xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8 max-w-2xl mx-auto">
            Real-time threat detection and system monitoring. Protect your
            computer from malware, viruses, and security threats.
          </p>
            ...
            <div className="flex items-center justify-between mb-6">
              <div className="text-left">
                <h2 className="text-2xl font-bold text-white mb-2">
                  SystemProbe Security
                </h2>
                <p className="text-gray-400">
                  Version 2026.02.27 • Windows 10/11
                </p>
              </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="p-6 border border-gray-800 bg-gray-800/50 rounded-lg">
            ...
            <p className="text-gray-400 text-sm">
              Continuous monitoring and instant threat blocking to keep your
              system safe.
            </p>
          </div>
          ...
          <div className="p-6 border border-gray-800 bg-gray-800/50 rounded-lg">
            ...
            <p className="text-gray-400 text-sm">
              Advanced scanning engine detects and removes viruses, trojans, and
              spyware.
            </p>
          </div>
          ...
          <div className="p-6 border border-gray-800 bg-gray-800/50 rounded-lg">
            ...
            <p className="text-gray-400 text-sm">
              Protects you from malicious websites and phishing attacks while
              browsing.
            </p>
          </div>
          ...
          <div className="p-6 border border-gray-800 bg-gray-800/50 rounded-lg">
            ...
            <p className="text-gray-400 text-sm">
              Protects your important files from ransomware encryption attacks.
            </p>
          </div>
          ...
          <div className="p-6 border border-gray-800 bg-gray-800/50 rounded-lg">
            ...
            <p className="text-gray-400 text-sm">
              Advanced firewall monitors network traffic and blocks suspicious
              connections.
            </p>
          </div>
          ...
          <div className="p-6 border border-gray-800 bg-gray-800/50 rounded-lg">
            ...
            <p className="text-gray-400 text-sm">
              Scans email attachments and blocks malicious content
              automatically.
            </p>
          </div>
        </div>
      ...
      <footer className="border-t border-gray-800 bg-gray-950">
        <div className="max-w-6xl mx-auto px-6 py-12">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              <img
                src="/SYSTEMPROBE_LOGO_PNG.png"
                alt="SystemProbe"
                className="h-12 mb-3"
              />
              <p className="text-sm text-gray-400">
                Trusted security for millions worldwide.
              </p>
            </div>
